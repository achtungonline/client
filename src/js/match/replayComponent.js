...
module.exports = React.createClass({
    ...
    getInitialState: function () {
        return {
            localGame: this.props.game,
            gameHistory: null,
            roundStartScore: this.props.startScoreState,
    ...
    componentDidMount: function () {
        ...
        var scoreHandler = ScoreHandler({game: replayGame, scoreState: this.state.replayScoreState});
